...
class ShuffleNetV2(nn.Module):
    def __init__(self, net_size, num_classes=16):
        ...
        self.conv1 = nn.Conv1d(2, 24, kernel_size=7, stride=1, padding=3, bias=False)
...
def shufflenet1d(net_size=0.5, num_classes=16):
    return ShuffleNetV2(net_size=0.5, num_classes=16)
